<script>
	export default{name: 'FirstViewComponent'}
</script>
...
<template>
    <!-- ファーストビュー -->
    <div class="c-contents -f-view w1100 w95s mgb3 mgb5s">
        <div class="imgBox a-fviewOutImg">
            <img class="sp"    src="images/f-view/f-sample_sp.png" alt="">
            <img class="tb-pc" src="images/f-view/f-sample_tbpc.png" alt="">
        </div>
        <!-- ページタイトル -->
